export const adminUi = {
  ...
  hero: 'rounded-[32px] border border-slate-200 bg-white px-6 py-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)] sm:px-8',
  ...
  card: 'rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_14px_34px_rgba(15,23,42,0.05)]',
  ...
  tableShell: 'overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_14px_34px_rgba(15,23,42,0.05)]',
  tableHead:
...
export const adminSemantic = {
  ...
  brand: 'border-[#C8974A]/20 bg-[#C8974A]/10 text-[#9a6e2e]',
} as const;
